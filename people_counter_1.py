...
video_path = "DATA/INPUTS/people_in_streets_2.mp4"
...
polygon_points = np.array([[580, 700], [1035, 700], [1454, 1000], [132, 1000]], dtype=np.int32)
...
filename = "DATA/OUTPUTS/people_counter_1.mp4"
